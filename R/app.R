        ...
        shiny::mainPanel(
          ...
          shiny::tabsetPanel(
            ...
            shiny::tabPanel(
              title = "1. Shorten",
              shiny::h3("Task"),
              shiny::p("Simplify your hex code from six to three values."),
              shiny::h3("Explanation"),
              shiny::tags$div(
                shiny::tags$ul(
                  shiny::tags$li("There are three pairs of alphanumeric characters in a colour hex code"),
                  shiny::tags$li("The pairs represent red, green and blue (so #A1B2C3 encodes A1 for red, B2 for green and C3 for blue)"),
                  shiny::tags$li("The first value of each pair contains enough information for our needs (so #A1B2C3 becomes #ABC)")
                )
              ),
              shiny::h3("Hints"),
              shiny::HTML(
            ...
            shiny::tabPanel(
              title = "2. RGB",
              shiny::h3("Task"),
              shiny::p("Convert your shortened hex code to a bar chart of decimal values for red, green and blue."),
              shiny::h3("Explanation"),
              shiny::tags$div(
                shiny::tags$ul(
                  ...
                  shiny::tags$li("So you can convert your shortened hex code to decimal values  (so #ABC encodes 10, 11 and 12 for red, green and blue)"),
                  shiny::tags$li("Imagine a bar chart of these values to get a sense of the RGB 'profile' of your shortened hex code")
                )
              ),
              shiny::h3("Hints"),
              shiny::HTML(
            ...
            shiny::tabPanel(
              title = "3. Hue",
              shiny::h3("Task"),
              shiny::p("Select the hue with the closest RGB profile to your shortened hex code."),
              shiny::h3("Explanation"),
              shiny::tags$div(
                shiny::tags$ul(
                  shiny::tags$li("'Hue' is basically the 'name' of a colour, e.g. 'red'"),
                  shiny::tags$li("You can infer hue from the relative ranking in the amount of red, blue and green (so #F11 has a lot of red and a tied, smaller amount of green and blue)"),
                  shiny::tags$li("Compare the relative RGB rankings of your shortened hex code against profiles for the primary colours of red, green and blue, and their secondary and tertiary mixtures")
                )
              ),
              shiny::h3("Hints"),
              shiny::HTML(
            ...
            shiny::tabPanel(
              title = "4. Saturation",
              shiny::h3("Task"),
              shiny::p("Select the saturation level that has the closest range to your shortened hex code."),
              shiny::h3("Explanation"),
              shiny::tags$div(
                shiny::tags$ul(
